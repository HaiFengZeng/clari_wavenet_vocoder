...
from .mixture import sample_from_discretized_mix_logistic,sample_from_discretized_gaussian
from .upsample import  UpSampleConv,ClariUpsampleConv
...
class WaveNet(nn.Module):
    ...
    def __init__(self, out_channels=256, layers=20, stacks=2,
        ...
        if upsample_conditional_features:
            ...
            if output_type == 'Gaussian' and False:
                self.upsample_conv = ClariUpsampleConv()
        else:
    ...
    def incremental_forward(self, initial_input=None, c=None, g=None,
        ...
        for t in tqdm(range(T)):
            ...
            if self.scalar_input:
                sample_fn = sample_from_discretized_mix_logistic
                if self.output_type == "Gaussian":
                    sample_fn = sample_from_discretized_gaussian
                x = sample_fn(
