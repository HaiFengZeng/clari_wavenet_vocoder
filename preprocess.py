...
if __name__ == "__main__":
    # args = docopt(__doc__)
    name = 'ljspeech'  # args["<name>"]
    in_dir = '/home/jinqiangzeng/work/data/speech/ljspeech/LJSpeech-1.0'  # args["<in_dir>"]
    out_dir = './data/{}'.format(name)#args["<out_dir>"]
    num_workers = None #args["--num_workers"]
    num_workers = cpu_count() if num_workers is None else int(num_workers)
    preset = '/home/jinqiangzeng/work/mypycharm/wavenet/wavenet_vocoder/presets/ljspeech_gaussian.json'#args["--preset"]
